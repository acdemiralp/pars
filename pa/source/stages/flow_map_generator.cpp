...
std::unique_ptr<vector_field> flow_map_generator::generate  (const scalar time, const scalar resolution_scale)
{
...
{
  // Advect particles, storing only the final positions.

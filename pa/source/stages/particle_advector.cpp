...
void                          particle_advector::set_local_vector_field    (std::optional<vector_field>*                local_vector_field    )
{
  local_vector_field_     = local_vector_field    ;
}
void                          particle_advector::set_neighbor_vector_fields(std::array<std::optional<vector_field>, 6>* neighbor_vector_fields)
{
...
std::vector<particle>         particle_advector::advect                    (std::vector<particle>                       particles             )
{
...
void                          particle_advector::load_balance_distribute   (      std::vector<particle>& particles                                                                                   )
{
...
particle_advector::round_info particle_advector::compute_round_info        (const std::vector<particle>& particles, const std::vector<integral_curves>& integral_curves                              )
{
...
void                          particle_advector::trace                     (const std::vector<particle>& particles,       std::vector<integral_curves>& integral_curves,       round_info& round_info)
{
...
void                          particle_advector::out_of_bounds_distribute  (      std::vector<particle>& particles,                                                      const round_info& round_info)
{
  particles.clear();
...
bool                          particle_advector::check_completion          (const std::vector<particle>& particles                                                                                   )
{
